const lessons = [
    ...
    { id: 8, subject: "Computer", location: "Oxford", price: 150, spaces: 5, icon: "fas fa-laptop-code", rating: 4 },
    { id: 9, subject: "Drama", location: "Cambridge", price: 85, spaces: 5, icon: "fas fa-theater-masks", rating: 4},
    { id: 10, subject: "PE", location: "Bristol", price: 60, spaces: 5, icon: "fas fa-basketball-ball", rating: 3}
];
